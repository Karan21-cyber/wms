...
const HomePage = () => {
  return (
    ...
    "
      ...
      <div className="copy-right-wrapper w-full flex justify-center items-center pb-5 text-sm text-gray-500">
        All rights reserved. © {new Date().getFullYear()} Space World
      </div>
    </>
  );
};
